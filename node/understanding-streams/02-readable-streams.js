...
async function main() {
  ...
  // node/streams/readBig/readBig.js (ІСНУЮЧИЙ ПРАКТИЧНИЙ ПРИКЛАД У
  // ЦЬОМУ РЕПОЗИТОРІЇ) ЧЕРЕЗ ЗМІННУ split, ЩО "ЗБЕРІГАЄ" НЕПОВНИЙ
...
//   node/streams/readBig/readBig.js цього репозиторію)
