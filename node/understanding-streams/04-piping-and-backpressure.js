...
async function main() {
  ...
  // node/understanding-file-system/03-file-handles.js, розділ 5).
  ...
  // ВИКОРИСТОВУЄТЬСЯ В node/streams/readBig/readBig.js (ІСНУЮЧИЙ
  // ПРАКТИЧНИЙ ПРИКЛАД У ЦЬОМУ РЕПОЗИТОРІЇ — ТАМ readStream.pause()
...
// - реальний практичний приклад у ЦЬОМУ репозиторії
//   (node/streams/readBig/readBig.js) РУЧНИМИ pause()/resume() РОБИТЬ
